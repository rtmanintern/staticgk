...
function viewresult()
{
	...
	var gv8=document.getElementById("GridView8");
	var gv9=document.getElementById("GridView9");
	var gv10=document.getElementById("GridView10");
	var gv11=document.getElementById("GridView11");
	var gv12=document.getElementById("GridView12");
	var qus=localStorage.getItem("TESTQ_M");
	var att=localStorage.getItem("TESTA_M");
	var qus_s=qus.split('/');
	var att_s=att.split('/');
	for (i=1;i<=20;i++)
	{
		...
		{
		gv1.rows[i].cells[0].innerHTML=gv8.rows[qus_s[j]].cells[0].innerHTML;
		gv1.rows[i].cells[1].innerHTML=gv8.rows[qus_s[j]].cells[1].innerHTML;
		gv1.rows[i].cells[2].innerHTML=gv8.rows[qus_s[j]].cells[2].innerHTML;
		gv1.rows[i].cells[3].innerHTML=gv8.rows[qus_s[j]].cells[3].innerHTML;
		gv1.rows[i].cells[4].innerHTML=gv8.rows[qus_s[j]].cells[4].innerHTML;
		gv1.rows[i].cells[5].innerHTML=gv8.rows[qus_s[j]].cells[5].innerHTML;
		gv1.rows[i].cells[6].innerHTML=gv8.rows[qus_s[j]].cells[6].innerHTML;
		gv1.rows[i].cells[8].innerHTML=gv8.rows[qus_s[j]].cells[8].innerHTML;
		}
		 else if(i==16||i==17)
		{
		gv1.rows[i].cells[0].innerHTML=gv9.rows[qus_s[j]].cells[0].innerHTML;
		gv1.rows[i].cells[1].innerHTML=gv9.rows[qus_s[j]].cells[1].innerHTML;
		gv1.rows[i].cells[2].innerHTML=gv9.rows[qus_s[j]].cells[2].innerHTML;
		gv1.rows[i].cells[3].innerHTML=gv9.rows[qus_s[j]].cells[3].innerHTML;
		gv1.rows[i].cells[4].innerHTML=gv9.rows[qus_s[j]].cells[4].innerHTML;
		gv1.rows[i].cells[5].innerHTML=gv9.rows[qus_s[j]].cells[5].innerHTML;
		gv1.rows[i].cells[6].innerHTML=gv9.rows[qus_s[j]].cells[6].innerHTML;
		gv1.rows[i].cells[8].innerHTML=gv9.rows[qus_s[j]].cells[8].innerHTML;
		}
		 else if(i==18)
		{
		gv1.rows[i].cells[0].innerHTML=gv10.rows[qus_s[j]].cells[0].innerHTML;
		gv1.rows[i].cells[1].innerHTML=gv10.rows[qus_s[j]].cells[1].innerHTML;
		gv1.rows[i].cells[2].innerHTML=gv10.rows[qus_s[j]].cells[2].innerHTML;
		gv1.rows[i].cells[3].innerHTML=gv10.rows[qus_s[j]].cells[3].innerHTML;
		gv1.rows[i].cells[4].innerHTML=gv10.rows[qus_s[j]].cells[4].innerHTML;
		gv1.rows[i].cells[5].innerHTML=gv10.rows[qus_s[j]].cells[5].innerHTML;
		gv1.rows[i].cells[6].innerHTML=gv10.rows[qus_s[j]].cells[6].innerHTML;
		gv1.rows[i].cells[8].innerHTML=gv10.rows[qus_s[j]].cells[8].innerHTML;
		}
		 else if(i==19)
		{
		gv1.rows[i].cells[0].innerHTML=gv11.rows[qus_s[j]].cells[0].innerHTML;
		gv1.rows[i].cells[1].innerHTML=gv11.rows[qus_s[j]].cells[1].innerHTML;
		gv1.rows[i].cells[2].innerHTML=gv11.rows[qus_s[j]].cells[2].innerHTML;
		gv1.rows[i].cells[3].innerHTML=gv11.rows[qus_s[j]].cells[3].innerHTML;
		gv1.rows[i].cells[4].innerHTML=gv11.rows[qus_s[j]].cells[4].innerHTML;
		gv1.rows[i].cells[5].innerHTML=gv11.rows[qus_s[j]].cells[5].innerHTML;
		gv1.rows[i].cells[6].innerHTML=gv11.rows[qus_s[j]].cells[6].innerHTML;
		gv1.rows[i].cells[8].innerHTML=gv11.rows[qus_s[j]].cells[8].innerHTML;
		}
		 else if(i==20)
		{
		gv1.rows[i].cells[0].innerHTML=gv12.rows[qus_s[j]].cells[0].innerHTML;
		gv1.rows[i].cells[1].innerHTML=gv12.rows[qus_s[j]].cells[1].innerHTML;
		gv1.rows[i].cells[2].innerHTML=gv12.rows[qus_s[j]].cells[2].innerHTML;
		gv1.rows[i].cells[3].innerHTML=gv12.rows[qus_s[j]].cells[3].innerHTML;
		gv1.rows[i].cells[4].innerHTML=gv12.rows[qus_s[j]].cells[4].innerHTML;
		gv1.rows[i].cells[5].innerHTML=gv12.rows[qus_s[j]].cells[5].innerHTML;
		gv1.rows[i].cells[6].innerHTML=gv12.rows[qus_s[j]].cells[6].innerHTML;
		gv1.rows[i].cells[8].innerHTML=narr();
...
function start()
{
	document.getElementById("reattempt").style.display="none";
	document.getElementById("reattempt").style.width="0%";
	document.getElementById("view_result").style.width="100%";
	var today = new Date();
var dd = String(today.getDate()).padStart(2, '0');
var mm = String(today.getMonth() + 1).padStart(2, '0'); //January is 0!
var yyyy = today.getFullYear();
...
function submit()
{
	...
	s=c*2-w*0.5;
	localStorage.setItem("TESTQ_M",qus);
	localStorage.setItem("TESTA_M",att);
...
today =  dd + '/' + mm + '/' + yyyy;
localStorage.setItem("TODAY_M",today);
var r=dd%10;
r=(r*7)%10;
r=r+20;
...
if (s>=r)
{
	...
	localStorage.setItem("DETAILS_M",details);
...
{
	if(localStorage.getItem("DETAILS_M")!=undefined)
	{
		var s=localStorage.getItem("DETAILS_M");
		var data=s.split('/');
